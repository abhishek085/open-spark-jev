...
- **Records written**: 400  (`data/benchmarks/external/ext-vuln-code.jsonl`)

## What it is
400 code snippets (200 matched vulnerable/fixed pairs) from CyberNative/Code_Vulnerability_Security_DPO, blind to vulnerability class.
