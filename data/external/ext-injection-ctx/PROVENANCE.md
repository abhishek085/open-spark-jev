...
- **Records written**: 662  (`data/benchmarks/external/ext-injection-ctx.jsonl`)

## What it is
All 662 labelled messages of deepset/prompt-injections, judged against a described news-assistant deployment.
